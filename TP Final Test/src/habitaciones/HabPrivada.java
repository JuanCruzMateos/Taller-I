...
/**
 * @author Clase habitacion privada que se extiende de la superclase habitacion
 * <br>
 */
public class HabPrivada extends Habitacion {
    ...
    /**
     * metodo boolean que devuelve true o false en el caso de poder haber agregado
