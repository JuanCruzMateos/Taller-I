...
/**
 * @author Clase Factory en donde se generaran las distintas habitaciones : Habitacion Compartida, Habitacion Privada y Sala de Terapia Intensiva<br>
 */
public class HabitacionFactory {
     ...
     * @throws TipoHabitacionInvalidaException : lanza una excepción informando al usuario que la habitacion ingresada es nula o erronea
     */
