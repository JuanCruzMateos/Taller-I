...
/**
 * @author Clase Factory en donde se generaran los distintos pacientes segun su rangoEtario : nino, joven y mayor
 */
public class PacienteFactory {
     ...
     *                    <b> Pre : </b> Paciente tiene que ser distinto de null, ademas de sus parametros<br>
     *                    <b> Post : </b> Obtener un paciente de tipo nino,joven o mayor<br>
     * @return retorna un paciente con su subclase determinada por el rangoEtario<br>
     * @throws TipoPacienteInvalidoException : lanza una excepcion si el rangoEtario ingresado es nulo o erroneo
     */
