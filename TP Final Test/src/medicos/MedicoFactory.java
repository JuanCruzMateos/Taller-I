...
/**
 * @author usuario
 * Clase Factory en donde se generaran los distintos medicos <br>
 */
public class MedicoFactory {
     ...
     * <b> Pre: </b> los strings de especialidad, contratacion y posgrado deben ser distinto de null o erroneos <br>
     ...
     * @param posgrado<br>
     * @return retorna un medico con una determinada especialidad, contratacion y posgrado<br>
     * @throws PosgradoInvalidoException     : lanza una excepcion en el caso de que el posgrado sea erroneo o nulo
    ...
    public static IMedico getMedico(String nomAp, String dni, String domicilio, String ciudad, String tel, int numMat, String especialidad, String contratacion, String posgrado, double honorario) throws PosgradoInvalidoException, ContratacionInvalidaException, EspecialidadInvalidaException {
        ...
        if (encapsuladobis != null) {
            if (contratacion.equalsIgnoreCase("Permanente"))
                ...
                throw new ContratacionInvalidaException("No existe un medico con este tipo de contratacion: ", contratacion);
        }
        return respuesta;
